module zmatrix_class
  ...
  character(len=*), parameter :: version = "$Id: zmatrix_class.f90,v 1.10 2004/08/16 02:29:28 aidan Exp aidan $" 
...
contains
  ...
  subroutine delete_zmatrix(zmatrix)
    ...
    ! deallocate(zmatrix%zmatrices,stat=error)
    if (associated(zmatrix%zmatrices)) deallocate(zmatrix%zmatrices)
    ! print *,'here'
